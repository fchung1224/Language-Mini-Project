...
buzzfeed_final <- buzzfeed_clean %>%
  ...
  select(title, text, authors, source,type,WordCount,text_length,title_length) %>%
...
buzzfeed_final_ish <- cbind(buzzfeed_final,has_trump) 
```
...
buzzfeed_final_ish <- cbind(buzzfeed_final_ish,has_author) 
```
